...
const getFlashExchangePage = (params) =>
  apiService.get("mystery-web-user/withdrawal/flashExchangePage", params); // 闪兑历史
...
const getGoogleValidateStatus = (params) =>
  apiService.get(
    "mystery-web-user/auth/account/getGoogleValidateStatus",
    params,
  ); // 获取是否开启谷歌验证
...
const getActivityLists = (params) =>
  apiService.get("mystery-web-user/activity/findList", params); // 查询正在进行的活动
const getActivityTargetList = (params) =>
  apiService.get("mystery-web-user/activity/targetList", params); // 奖励列表
const getActivityTargetHeaderDataTotal = (params) =>
  apiService.get("mystery-web-user/activity/targetHeaderDataTotal", params); // 奖励领取数据统计
const activityReceive = (params) =>
  apiService.get("mystery-web-user/activity/receive", params); // 奖励领取
const getActivityPoint = (params) =>
  apiService.get("mystery-web-user/activity/getPoint", params); // 积分获取
const flashExchange = (params) =>
  apiService.post("mystery-web-user/withdrawal/flashExchange", params); // 闪兑
const exchangeRateV2 = (params) =>
  apiService.get("mystery-web-user/index/exchangeRateV2", params); // 获取真实汇率
