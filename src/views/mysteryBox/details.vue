    ...
    <div class="details_wrapper">
            ...
            <div class="lottery_boxs">
                <div class="lottery_boxs_l">
                    ...
                    <div class="description_box">
                        ...
                        <div class="text">Enter now for a chance to win Mutant Ape Yacht Club #8039. The MUTANT APE YACHT
                            CLUB is a collection of up to 20,000 Mutant Apes that can only be created by exposing an
                            existing Bored Ape to a vial of MUTANT SERUM or by minting a Mutant Ape in the public sale</div>
                    </div>
                </div>
        ...
        <div class="nft_series">
            <div class="home-public-title">
                ...
                <div class="title_description">Amet ornare massa praesent lacus. In mi tristique enim tellus amet semper a.
                    Donec ac congue nunc porta semper auctor enim.</div>
            </div>
            <div class="nft_series_list">
                <div class="nft_series_item" :class="[`series_level_${item.type}`]" v-for="(item, index) in seriesList"
                    :key="index">
                    ...
                    <div class="mask_box">
                        <div class="show_series_btn" @click="handleShowNft(item)">Show NFTs</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="contents-info">
            <div class="home-public-title">
                ...
                <div class="title-box-r">
                    ...
                    <el-input v-model.number="snapshotId" class="snapshot_input" placeholder="Search by snapshot ID">
                    </el-input>
                    <div class="title">Timestamp</div>
                    <el-date-picker v-model="timestamp" type="datetime" clearable />
                </div>
            </div>
                ...
                <el-table-column prop="date" label="Action" align="center">
                    <template #default="scope">
                        <div class="active_btn">
                            <img class="nft_info" @click="handleActive(scope.row)" src="@/assets/svg/box/icon_info.svg"
                                alt="">
                            <img class="nft_info_active" @click="handleActive(scope.row)"
                                src="@/assets/svg/box/icon_info_active.svg" alt="">
                        </div>
                    </template>
                </el-table-column>
            </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            nftData: [11, 2, 2, 2, 2,],
            seriesList: [{ type: "1" }, { type: "2" }, { type: "3" }, { type: "4" }, { type: "1" }, { type: "2" }, { type: "3" }, { type: "4" }, { type: "1" }, { type: "2" }, { type: "3" }, { type: "4" },],
            nftList: []
        };
    },
    methods: {
