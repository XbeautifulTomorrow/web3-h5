<template>
  <div class="my_wallet_wrapper">
    ...
    <el-dialog v-model="showInventory" width="78.125rem" lock-scroll :close-on-click-modal="false"
      ...
      <div class="withdraw_condition" v-else>
        ...
        <div class="hint_text">
          <img src="" alt="">
          <span>
            Ensure you've selected the same network for both withdrawal and deposit. Please check if the depositing
    ...
    <!-- 创建一元购弹窗 -->
    <el-dialog v-model="showCompetition" width="43.75rem" class="dialog_competition" :close-on-click-modal="false"
      :before-close="handleClose">
      <div class="close_btn" @click="handleClose()">
        <el-icon>
          <Close />
