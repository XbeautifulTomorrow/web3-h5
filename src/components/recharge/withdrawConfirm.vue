  ...
  <div>
    ...
    >
      ...
      <div class="public-dialog-content form-content">
        ...
        />
        <Image v-else fit="cover" :src="loadingImg" class="loading-img" />
...
import loading from "@/assets/img/home/loading.png";
...
export default {
  ...
  methods: {
    ...
    gasContent() {
      ...
      strV += `<img style='width: 1.5rem;height: auto;margin-right: 0.25rem' src='${usdImg}'>`;
    ...
    viewTxid() {
      const transactionUrl = import.meta.env.VITE_APP_TRANSACTION_ADDR;
